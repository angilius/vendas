...
<tr>
    ...
    <td><input type="text" class="form-control" name="NomeProduto" value="{{ $produto->NomeProduto }}"></td>
</tr>
<tr>
    <td><label>Código de Barras:</label></td>
    <td><input type="text" class="form-control" name="CodBarras" value="{{ $produto->CodBarras }}"></td>
</tr>
<tr>
    <td><label>Preço:</label></td>
    <td><input type="text" class="form-control" name="ValorUnitario" value="{{ $produto->ValorUnitario }}"></td>
</tr>
<tr>
