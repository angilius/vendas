...
<form action="/cadastrar-cliente" method="POST">
    ...
    <table>       
<tr>
    <td><label>Nome:</label></td><td><input type="text" class="form-control" name="NomeCliente"></td>
</tr>
<tr>
    <td><label>CPF:</label></td><td><input type="text" class="form-control" name="CPF"></td>
</tr>
<tr>
    <td><label>EMAIL:</label></td><td><input type="text" class="form-control" name="email"></td>
</tr>
<tr>
