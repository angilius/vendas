...
<form action="/cadastrar-produto" method="POST">
    ...
    <table>       
<tr>
    <td><label>Produto:</label></td><td><input type="text" class="form-control" name="NomeProduto"></td>
</tr>
<tr>
    <td><label>Código de Barras:</label></td><td><input type="text" class="form-control" name="CodBarras"></td>
</tr>
<tr>
    <td><label>Preço:</label></td><td><input type="text" class="form-control" name="ValorUnitario"></td>
</tr>
<tr>
