...
<form action="/cadastrar-pedido" method="POST">
    ...
    <table>       
<tr>
    <td><label>Numero:</label></td><td><input type="text" class="form-control" name="NumeroPedido"></td>
</tr>
<tr>
    <td><label>Quantidade:</label></td><td><input type="text" class="form-control" name="Quantidade"></td>
</tr>
<tr>
    <td><label>Data:</label></td><td><input type="text" class="form-control" name="DtPedido"></td>
</tr>
<tr>
