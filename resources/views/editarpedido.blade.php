...
<br><br>
<form action="/editar-pedido/{{ $pedido->id }}" method="POST">
    @csrf
    <table>       
<tr>
    <td><label>Numero:</label></td>
    <td><input type="text" class="form-control" name="NumeroPedido" value="{{ $pedido->NumeroPedido }}"></td>
</tr>
<tr>
    <td><label>Quantidade:</label></td>
    <td><input type="text" class="form-control" name="Quantidade" value="{{ $pedido->Quantidade }}"></td>
</tr>
<tr>
    <td><label>DATA:</label></td>
    <td><input type="text" class="form-control" name="DtPedido" value="{{ $pedido->DtPedido }}"></td>
</tr>
<tr>
